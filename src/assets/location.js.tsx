const locations = [
  ...
  },
  {
    ...
    description:
      "The Sai Gon Central Post Office is a must-visit attraction in Ho Chi Minh City. Construction of the city's Central Post Office began in 1886 and was completed in 1891 under the skillful direction of the renowned French architect Gustave Eiffel. Visitors can admire the grand interior with its high ceilings, intricate details, and beautiful mosaic floors. The post office still functions as a working post office, making it a unique experience to send postcards or letters from this histcoordinatesc site. The Sai Gon Central Post Office is open from 7 am to 9 pm, every day of the week.",
  },
  {
    label: 'Bitexco',
    lstImgs: [
  ...
  },
  {
    ...
    description:
      "Buu Long Pagoda is one of the most uniquely descriptionigned temples, reminiscent of the Golden Temple in Thailand. According to the sharing of Master Vien Minh, the temple was inspired by the architectural style of Buddhism coordinatesginating from India. Situated in the temple's courtyard is a large lake. Directly behind the lake stands the 56-meter-tall Gotama Cetiya tower. This tower is also hailed as the largest stupa in Vietnam. Apart from its distinctive architectural features, the pagoda is perched atop a hill, offering visitors not only a sense of serenity but also refreshing, clean air. This is truly a spiritual tourism descriptiontination that visitors to Ho Chi Minh City cannot miss. The pagoda is open to visitors from 8:00 AM to 6:00 PM daily.",
  },
  {
  ...
  },
  {
    ...
    description:
      'Independence Palace is a histcoordinatescal landmark that preserves proud milestones of the Vietnamese nation in the struggle to protect the homeland. descriptionigned by architect Ngô Viết Thụ with the intention of creating a culturally significant structure, Independence Palace embodies Eastern cultural elements throughout its interior, exterior, and landscaping, seamlessly blended with modern descriptionign. Specifically, the architecture of the building is modeled after Han-Vietnamese characters with auspicious meanings. With a total area of ​​120,000 square meters, the sit te is divided into three distinct zones (Fixed Zone, Specialized Zone, Supplementary Zone), each with its own unique characteristics. Independence Palace is open to tourists for visits every day of the week during two time slots: from 7:30 am to 11:30 am in the morning and from 1:00 pm to 5:00 pm in the afternoon.',
  },
  {
    label: 'Ho_Con_Rua',
    lstImgs: [
    ...
    address: 'the intersection of Tran Cao Van, Pham Ngoc Thach, Vo Van Tan streets in District 3, Ho Chi Minh City.',
    description:
  ...
  },
  {
    ...
    description:
      'The Ho Chi Minh City Museum is not only a place that reenacts the history of old Saigon but also an attractive tourist descriptiontination for many travelers. This structure, descriptionigned by French architect Alfred Foulhoux, was built in 1885 and completed in 1890, covering an area of nearly 2 hectares. The museum is constructed in a neoclassical style with its facade bearing Western architectural influences, while the roof is descriptionigned in an Eastern style. It is divided into multiple rooms, each showcasing artifacts according to different themes. With its unique architecture, housed within a century-old building, the Ho Chi Minh City Museum is a fascinating attraction that visitors cannot afford to miss. The museum is open from 8:00 to 17:00.',
  },
  {
  ...
  },
  {
    ...
    description:
      'The Thu Ngu Flagpole stands on a piece of land at the confluence of the Saigon River and the Ben Nghe Canal. Built around the first half of the 19th century, the Thu Ngu Flagpole has been standing for over 150 years. Initially constructed for the purpose of observing ship traffic on the Saigon River, it no longer serves its coordinatesginal function today. Instead, the Thu Ngu Flagpole has become a scenic spot for sightseeing and exploration, offering visitors the opportunity to delve into the coordinatesgins and histcoordinatescal development of the city. ',
  },
  {
    ...
    description:
      'Ba Thien Hau Temple is one of the oldescriptiont Chinese temples in Ho Chi Minh City. Built in 1760 by a group of Chinese (Tue Thanh), the temple has stood for 261 years and has undergone numerous renovations while still retaining its unique architectural style. The temple features a distinctive descriptionign with three main sections: the Front Hall, the Middle Hall, and the Rear Hall. Additionally, one of its most characteristic features is the unique spiral incense hanging from the ceiling. Visitors to the temple can witness precious artifacts preserved within, participate in festivals, and more. The temple is open from Monday to Sunday, with two visiting sessions: from 6:00 to 11:30 in the morning and from 13:00 to 16:30 in the afternoon.',
  },
  {
    label: 'Thao_Cam_Vien',
    lstImgs: [
    ...
    description:
      "Saigon Zoo and Botanical Gardens is one of Vietnam's oldescriptiont amusement parks and also the largest botanical garden in Saigon, serving as a conservation area for flora and fauna. Saigon Zoo and Botanical Gardens is a renowned zoo with numerous rare and precious species, boasting 590 individuals of 125 species of animals, and 1,800 woody plants of 260 species. The zoo is divided into various areas such as carnivores, mammals, reptiles, herbivores, birds, small animals, and more. Additionally, visitors can participate in thrilling ridescription, enjoy spectacular magic shows, musical performances, animal circus acts, and other exciting activities. Moreover, the park offers a refreshing atmosphere and tranquil spaces for relaxation. Saigon Zoo and Botanical Gardens opens from 7:00 to 17:30 every day of the week.",
  },
  {
    label: 'Cho_Binh_Tay',
    lstImgs: [
      ...
      'https://image.vietgoing.com/descriptiontination/vietgoing_kuv2106048052.webp',
    ],
    name: 'Binh Tay Market',
    coordinates: [10.7498953, 106.6496923],
    address: '57A Thap Muoi Street, Ward 2, District 6',
    description:
      "Binh Tay Market is a wholesale market that offers a wide range of high-quality goods with diverse descriptionigns. Moreover, it is known as the oldescriptiont Chinese market in Ho Chi Minh City. The market covers an area of up to 25,000 square meters with 13 gates and is descriptionigned in a distinctive Eastern architectural style. It features a total of 2,300 stalls selling over 30 different types of goods, organized into 5 distinct sections. This market operates from early morning until late at night. Particularly, if you want to explore the diversity of Saigon's cuisine, you should visit in the evening or late at night.",
  },
  {
    label: 'Chua_Phap_Hoa',
    lstImgs: [
